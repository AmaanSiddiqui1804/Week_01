...
public class DeckOfCards {
    ...
    public static String[][] distributeCards(String[] deck, int n, int x) {
        if (n % x != 0) {
            System.out.println("The number of cards cannot be evenly distributed among players.");
            return null;
        }
    ...
    public static void main(String[] args) {
        ...
        // Step 1: Initializing the deck
        String[] deck = initializeDeck();

        // Step 2: Shuffling the deck
        shuffleDeck(deck);

        // Step 3: Taking input for the number of cards to distribute and number of players
        System.out.print("Enter the number of cards to distribute: ");
        int n = input.nextInt();
        System.out.print("Enter the number of players: ");
        int x = input.nextInt();

        // Step 4: Method to distribute the deck of cards to players
        String[][] players = distributeCards(deck, n, x);

        // Step 5: Printing the players and their cards

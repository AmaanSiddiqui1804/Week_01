...
public class MatrixOperations {
    ...
    // Main method to perform matrix operations
    public static void main(String[] args) {
        int[][] matrixA = generateRandomMatrix(3, 3); // Generating Matrix A
        int[][] matrixB = generateRandomMatrix(3, 3); // Generating Matrix B
    ...
    public static int[][] generateRandomMatrix(int rows, int cols) {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                matrix[i][j] = random.nextInt(21) - 10; // Random values between -10 and 10
            }
        }
        return matrix;
    }
    ...
    public static int[][] multiplyMatrices(int[][] matrixA, int[][] matrixB) {
        int rowsA = matrixA.length, colsA = matrixA[0].length, colsB = matrixB[0].length;
    ...
    // Helper method to find the determinant of a 2x2 matrix
    public static int findDeterminant2x2(int[][] matrix) {
        return matrix[0][0] * matrix[1][1] - matrix[0][1] * matrix[1][0];
    }

    // Helper method to get the minor matrix for determinant calculation
